...
![AI makes software production cheap, while human understanding remains expensive](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/1.png)
...
![A human can actively work with only a few pieces of information while the full system is much larger](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/2.png)
...
![Humans divide a complex system into chunks and progressively focus on smaller parts](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/3.png)
...
![A human struggles with a few active items while an LLM can operate across a much larger chaotic information space](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/4.png)
...
![A developer tracing many files and dependencies to discover where a responsibility such as authentication actually lives](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/5.png)
...
![A simple architecture map sits above a large mass of generated code and lets a human navigate the system](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/6.png)
...
![A huge LLM context window is deliberately restricted to a much smaller effective 16K context](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/7.png)
...
![An AI agent sees its remaining context budget and decides what information to keep, summarize, or archive](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/9.png)
...
![Memory pressure transforms too much information into chunks, abstractions, hierarchy, and architecture](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/8.png)
...
![Hierarchical agent memory collapses completed subgoals into summaries while keeping the current subgoal expanded](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/11.png)
...
![A context-aware agent monitors memory usage and actively chooses what to keep, summarize, and archive](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/12.png)
...
![Four experiment conditions compare full context, restricted context, context awareness, and external memory](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/10.png)
...
![The same software task is given to four agents with different context constraints to compare the resulting code structures](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/13.png)
...
![Human comprehensibility is measured by how quickly and accurately an engineer can answer questions about a generated system](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/14.png)
...
![Constraining a huge context creates pressure to compress information into a cleaner hierarchy that humans can understand](/images/ai-can-govern-chaos-humans-cant-maybe-we-should-make-it-forget/15.png)
